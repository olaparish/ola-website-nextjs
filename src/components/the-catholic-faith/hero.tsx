  ...
  return (
    <div className="grid grid-rows-[1fr_auto] hero-h">
      <div className="relative">
        <img src="/images/catholic-faith/hero.webp" className="z-10 absolute w-full h-full object-cover" alt="Communion wine and Bible" />
        ...
        <div className="top-1/2 left-1/2 z-30 absolute justify-between items-center px-5 lg:px-25 w-full text-white text-center -translate-1/2 transform">
          ...
          <p className="lg:mt-5">
            <span className="block mx-auto lg:w-200">&quot;Go, therefore, and make disciples of all nations, baptizing them in the name of the Father, and of the Son, and of the Holy Spirit.&quot;</span>

...
type UpdateFieldNames = "occupation" | "placeOfWork" | "workDigitalAddress";

const UpdateProfileSchema = z.object({
  occupation: z.string("Invalid input").optional(),
  placeOfWork: z.string("Invalid input").optional(),
  workDigitalAddress: z
  ...
  const addressDetails: FormFieldType[] = [
    {
      ...
      name: "occupation",
      label: "Occupation",
      placeholder: parishioner?.occupation || "null",
    },
    {
      type: "text",
      name: "placeOfWork",
      label: "Place Of Work",
      placeholder: parishioner?.placeOfWork || "null",
    },
    {
      type: "text",
      name: "workDigitalAddress",
      label: "Work Digital Address (GPS)",
      placeholder: parishioner?.workDigitalAddress || "null",
    },
  ];
